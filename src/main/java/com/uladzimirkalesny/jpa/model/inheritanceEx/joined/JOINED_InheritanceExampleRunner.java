...
public class JOINED_InheritanceExampleRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Query creditCardQuery = entityManager.createQuery("from CreditCard");
            List<BillingDetails> resultList = (List<BillingDetails>) creditCardQuery.getResultList();
